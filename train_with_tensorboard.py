...
def fit_ont_epoch(net, yolo_losses, epoch, epoch_size, epoch_size_val, gen, genval, Epoch, cuda, writer, MIN_LOSS):
    ...
    if total_loss / (epoch_size + 1) < MIN_LOSS:
        ...
        MIN_LOSS = total_loss / (epoch_size + 1)
...
if __name__ == "__main__":
    ...
    classes_path = 'model_data/can_classes.txt'
    # ----------------------------------------------------#
    #   获取classes和anchor
    # ----------------------------------------------------#
    ...
    #   权值文件请看README，百度网盘下载
    # ------------------------------------------------------#
    model_path = "logs/Epoch145-Total_Loss2.9782-Val_Loss0.0000.pth"
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, Freeze_Epoch):
            MIN_LOSS = fit_ont_epoch(net, yolo_losses, epoch, epoch_size, epoch_size_val, gen, gen_val, Freeze_Epoch,
                                     Cuda, writer,
                                     MIN_LOSS)
            lr_scheduler.step()
